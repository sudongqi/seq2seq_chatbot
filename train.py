...
emb_weights = tf.Variable(tf.random_uniform([vocab_size, embedding_size], minval = -init_val, maxval = init_val), name="emb_weights")
...
#output layers
project_w = tf.Variable(tf.random_uniform([hidden_size, embedding_size], minval = -init_val, maxval = init_val), name="project_w")
project_b = tf.Variable(tf.random_uniform(shape=[embedding_size], minval = -init_val, maxval = init_val), name="project_b")
softmax_w = tf.Variable(tf.random_uniform([embedding_size, vocab_size], minval = -init_val, maxval = init_val), name="softmax_w")
softmax_b = tf.Variable(tf.random_uniform(shape=[vocab_size], minval = -init_val, maxval = init_val), name="softmax_b")
...
#helper function for recording the loss for each epoch
...
#local variables for the training
count = 0
epoch_loss = 0
epoch_count = 0
